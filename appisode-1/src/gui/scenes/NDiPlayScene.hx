 ...
 * @author Edwin
 */
class NDiPlayScene extends NDiAbstractScene
{
	...
	public function new()
	{
		...
		this.background = new NDiImage(NDiResourcesManager.loadImage(NDiGameConstants.ASSET_PACKAGE_GENERAL, "images/mig1/background_play"));
		...
		this.goButton = new NDiButton(NDiResourcesManager.loadImage(NDiGameConstants.ASSET_PACKAGE_GENERAL, "images/shared/play_button"));
		...
		this.goButtonHighlight = new NDiHighlightSignal(NDiResourcesManager.loadImage(NDiGameConstants.ASSET_PACKAGE_GENERAL, "images/shared/play_buttonHightlight"), null, null);
