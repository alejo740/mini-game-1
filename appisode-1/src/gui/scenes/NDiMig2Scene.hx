...
import managers.mig2.NDiCharacterManagerMig2;
import managers.mig2.NDiFootprintManagerMig2;
 ...
 * @author Edwin
 */
class NDiMig2Scene extends NDiAbstractScene
{
	
	private var background:NDiImage;
	private var characterManager:NDiCharacterManagerMig2;
	private var footprintManager:NDiFootprintManagerMig2;	
	...
	public function new()
	{
		...
		this.background = new NDiImage(NDiResourcesManager.loadImage(NDiGameConstants.ASSET_PACKAGE_GENERAL, "images/mig2/background"));
		...
		this.characterManager = new NDiCharacterManagerMig2();
		this.footprintManager = new NDiFootprintManagerMig2();
	...
	public function getFootsprintManager():NDiFootprintManagerMig2
	{
		return this.footprintManager;
	}
	public function getCharacterManager():NDiCharacterManagerMig2
	{
	...
	override public function onAdded():Void
    {
		...
		super.onAdded();
		NDiAudioManager.getInstance().playSoundEffect(NDiGameConstants.ARRAY_SOUNDS.get("MIG2-Intro"));		
	}
