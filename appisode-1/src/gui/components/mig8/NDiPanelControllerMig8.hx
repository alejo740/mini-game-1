 ...
 * @author Edwin
 */
class NDiPanelControllerMig8 extends Component
{
	private var zoomPanel:NDiRailZoomPanel;
	private var selectorPanel:NDiRailSelectorPanel;
	...
	private function loadInit():Void
	{
		...
		this.zoomPanel = new NDiRailZoomPanel();
		...
		this.selectorPanel = new NDiRailSelectorPanel();
	...
	public function getSelectorPanel():NDiRailSelectorPanel
	{
		return this.selectorPanel;
	}
	
	public function getZoomPanel():NDiRailZoomPanel
	{
		return this.zoomPanel;
	}
	
	public function getParent():NDiMig8Scene
	{
