 ...
 * @author Edwin
 */
class NDiCharacterManagerMig5 extends Component
{
	...
	public function new() 
	{
		...
		*/
		...
		this.bit = new NDiImage(NDiResourcesManager.loadImage(NDiGameConstants.ASSET_PACKAGE_GENERAL, "images/mig5/bit"));
		//this.bit.transform.visible = false;
		this.bit.transform.x._ = 230;
		this.bit.transform.y._ = 325;
		...
		//this.footBitArea.x._ = this.bit.transform.x._ - 65;
		//this.footBitArea.y._ = this.bit.transform.y._ + 22;
		
		this.footBitArea.x._ = NDiGameConstants.GAME_WIDTH * 0.5;
		this.footBitArea.y._ = NDiGameConstants.GAME_HEIGHT * 0.5;
		this.footBitArea.x._ -= 160;
		this.footBitArea.y._ -= 55;
	...
	public function getBean():NDiImage
	{
		return this.bean;
	}
	
	public function getDizzy():NDiImage
	{
		return this.dizzy;
	}
	
	public function getBit():NDiImage
	{
		return this.bit;
	}
	...
	private function addHeightLineSignal()
	{
		...
		this.lineHeightSignal.transform.y._ -= 4;
	...
	private function handlerPointerUp(e:PointerEvent):Void
	{
		...
		this.owner.parent.parent.get(NDiMig5Scene).getFootsprintManager().addFootPrint();
	}
